...
TARGET_URL = "https://esahubble.org/images/archive/category/starclusters/page/3"
DOWNLOAD_DIR = "star_clusters_dataset"

os.makedirs(DOWNLOAD_DIR, exist_ok=True)

def scrape_hubble_clusters():
    ...
    if not img_paths:
        print("No image URLs found. The website structure might be heavily obfuscated.")
    ...
    print(f"\nSuccess! Downloaded {downloaded_count} Star Cluster images to '{DOWNLOAD_DIR}'.")

if __name__ == "__main__":
    scrape_hubble_clusters()